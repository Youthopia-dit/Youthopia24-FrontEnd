      ...
      <div className="modal-background">
        ...
        >
          ...
          <div className="modal-content-wrapper">
            <div>
              <div className="modal-content-text-wrapper">
                <h2 className="modal-heading">{data.eventDetails.eventName}</h2>
                <p className="modal-desc">
                  Event Category - {data.eventDetails.eventCategory}
                </p>
                <p className="modal-desc">Venue - {data.eventDetails.venue}</p>
                <p className="modal-desc">Date and Time - </p>
                <p className="modal-desc">Team Name - {data.teamName}</p>
              </div>
            </div>
            <div>
              <div className="modal-content-member-wrapper">
          ...
          <div className="download_buttons-wrapper">
