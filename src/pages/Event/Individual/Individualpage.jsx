        ...
        <>
            <div className='individual-event'>
                <div className='event-container'>
                    <img src={Image} alt={eventDetails.name} className='event-image' />

                    <div className='event-details'>
                        <h2 className='event-title'>{eventDetails.name}</h2>
                        <div className='event-info'>
                            <span className='event-data'>{eventDetails.venue} • {eventDetails.date} • {eventDetails.time}</span>
                        </div>
                        ...
                        <div className='event-section'>
                            <p className='event-size'>Max Team Size: {eventDetails.teamMax}</p>
                            <p className='event-size'>Min Team Size: {eventDetails.teamMin}</p>
                        </div>
